...
class Ui_Form(object):
    ...
    def _Control(self):
        self.listprof = {"Злодіїв в законі": "п.1 <З>", "Авторитет": "п.1 <А>", "Лідер ОЗГ": "п.1  <Л>", "Резонанс в ЗМІ": "п.2",
                         "Проти основ національної безпеки": "п.5", "Вбивство на замовлення": "п.6", "Створення злочинної організації": "п.7",
                         "Бандетизм": "п.8", "Наркоділки з міжрегіональними звязками": "п.9", "Шахрайство": "п.10", "Службові злочини": "п.11",
                         "Нецільове використання бюджетних коштів": "п.12", "Ухилення від сплати податків": "п.13",
                         "Зловживання владою або службовим становищем": "п.14", "Тероризм": "п.15", "Вступили в незаконні бандитські угрупування": "п.16",
                         "Масові заворушення": "п.17", "Усфері державної таємниці": "п.18", "Розв'язування війни": "п.19",
