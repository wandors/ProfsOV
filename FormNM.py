...
class Ui_FormN(object):
    ...
    def retranslateUi(self, FormN):
        ...
        self.comboBox_5.setItemText(12, _translate("FormN", "Напад"))
        self.comboBox_5.setItemText(13, _translate("FormN", "Наркоділки з міжрегіональними звязками"))
        self.comboBox_5.setItemText(14, _translate("FormN", "Нецільове використання бюджетних коштів"))
        self.comboBox_5.setItemText(15, _translate("FormN", "Організація азартних ігор під матеріалну зацікавленість"))
        self.comboBox_5.setItemText(16, _translate("FormN", "Проти основ національної безпеки"))
        self.comboBox_5.setItemText(17, _translate("FormN", "Службові злочини"))
        self.comboBox_5.setItemText(18, _translate("FormN", "Ухилення від сплати податків"))
        self.comboBox_5.setItemText(19, _translate("FormN", "Хабар"))
        self.comboBox_5.setItemText(20, _translate("FormN", "Шахрайство"))
